...
// ================== PENDAFTARAN ==================
Route::get('/pendaftaran-mi', [PendaftaranMIController::class, 'create'])->name('pendaftaran.mi.create');
Route::post('/pendaftaran-mi', [PendaftaranMIController::class, 'store'])->name('pendaftaran.mi.store');

Route::get('/pendaftaran-tk', [PendaftaranTKController::class, 'create'])->name('pendaftaran.tk.create');
Route::post('/pendaftaran-tk', [PendaftaranTKController::class, 'store'])->name('pendaftaran.tk.store');
...
Route::middleware(['auth', 'role:admin'])->group(function () {
   ...
   Route::get('/pendaftaran-mi-approvel', 
    ...
    )->name('admin.pendaftaran-mi-approvel.index');
    ...
    Route::get('/pendaftaran-tk-approvel', [PendaftaranTKController::class, 'index'])->name('admin.pendaftaran-tk-approvel.tk.index');
    Route::post('/pendaftaran-tk-approvel/{id}/approve', [PendaftaranTKController::class, 'approve'])->name('admin.pendaftaran.tk.approve');
    Route::post('/pendaftaran-tk-approvel/{id}/reject', [PendaftaranTKController::class, 'reject'])->name('admin.pendaftaran.tk.reject');
...
Route::middleware(['auth', 'role:guru_mi'])->group(function () {
    ...
    Route::post('/pembayaran-mi/{id}/approve', [PembayaranMiController::class, 'approvePembayaran'])->name('pembayaran-mi.approve');
    ...
    Route::get('/nilai/rapor/{siswa}', [NilaiMiController::class, 'cetakRaporPdfAllKelas'])->name('nilai.cetakRaporPdfAllKelas');
    Route::get('/laporan-pembayaran-mi', [LaporanPembayaranMIController::class, 'index'])->name('laporan-pembayaran-mi.index');
});
...
Route::middleware(['auth', 'role:guru_tk'])->group(function () {
    ...
    Route::post('/pembayaran-tk/{id}/approve', [PembayaranTkController::class, 'approvePembayaran'])->name('pembayaran-tk.approve');
    Route::resource('nilai-tk', NilaiTkController::class)->parameters(['nilai-tk' => 'nilai']);
    ...
    Route::get('/nilai-tk/rapor/{siswa}', [NilaiTkController::class, 'cetakRaporPdfAllKelas'])->name('nilai-tk.cetakRaporPdfAllKelas');
    Route::get('/laporan-pembayaran-tk', [LaporanPembayaranTKController::class, 'index'])->name('laporan-pembayaran-tk.index');
});
...
Route::post('ortu/login', [OrangtuaAuthController::class, 'login'])->name('ortu.login.submit');
Route::post('ortu/logout', [OrangtuaAuthController::class, 'logout'])->name('ortu.logout');

// Dashboard Orang Tua
Route::middleware('auth')->group(function () {
    Route::get('ortu/dashboard', [OrangtuaDashboardController::class, 'index'])->name('ortu.dashboard');
});
