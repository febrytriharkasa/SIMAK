        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Edit / Konfirmasi Pembayaran TK</h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('pembayaran-tk.update', $pembayaran->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="jumlah" id="jumlah" class="form-control"
                                   value="{{ old('jumlah', $pembayaran->jumlah) }}" readonly>
