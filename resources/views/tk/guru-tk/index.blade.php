...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Data Guru Tk</h1>
    ...
    <div class="d-flex justify-content-between mb-3">
        <a href="{{ route('guru-tk.create') }}" class="btn btn-primary">+ Tambah Guru</a>

        <!-- Form Search -->
        <form action="{{ route('guru-tk.index') }}" method="GET" class="d-flex" style="max-width:300px;">
