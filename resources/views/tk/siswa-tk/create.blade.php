        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Tambah Siswa TK</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('siswa-tk.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="tahun" id="tahun" 
                                   ...
                                   value="{{ old('tahun') }}" placeholder="contoh: 2025">
                        ...
                        {{-- Email Wali --}}
                        <div class="mb-3">
                            <label for="email" class="form-label fw-semibold">Email Wali</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat_siswa" id="alamat_siswa" rows="3" 
                                      class="form-control @error('alamat_siswa') is-invalid @enderror">{{ old('alamat_siswa') }}</textarea>
