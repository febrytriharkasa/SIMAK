...
<div class="container-fluid p-3 rounded-3">
    ...
    {{-- ===================== Filter Kelas ===================== --}}
    <form action="{{ route('nilai.index') }}" method="GET" class="d-flex mb-3 align-items-center">
                        ...
                        @forelse($siswas as $index => $siswa)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('nilai.show', $siswa->id) }}" class="btn btn-info btn-sm text-white">
